...
- (void)setDataCount:(int)count range:(double)range
{
    ...
    [colors addObjectsFromArray:ChartColorTemplates.vordiplom];   //[a~e]
    [colors addObjectsFromArray:ChartColorTemplates.joyful];        //[f~j]
    [colors addObjectsFromArray:ChartColorTemplates.colorful];      //[k~o]
    [colors addObjectsFromArray:ChartColorTemplates.liberty];       //[p~i]
    [colors addObjectsFromArray:ChartColorTemplates.pastel];        //[j~y]
